#
#  Be sure to run `pod spec lint UZTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "sonson" => "" }
  # Or just: s.author    = "sonson"
  # s.authors            = { "sonson" => "" }
  s.social_media_url   = "http://twitter.com/sonson_twit"
  ...
  s.public_header_files = "UZTextView/UZTextView.h"
